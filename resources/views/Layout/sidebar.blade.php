...
<body>
    ...
    <aside id="sidebar"
        ...
        <nav class="flex flex-col space-y-1 text-gray-900 font-medium text-sm flex-1 overflow-y-auto">
            ...
            <div x-data="{ open: {{ request()->is('admin/karyawan*') || request()->is('admin/kategori*') || request()->is('admin/kandang*') || request()->is('admin/pakan*') ? 'true' : 'false' }} }">
                ...
                <div x-show="open" x-transition class="ml-6 mt-1 flex flex-col space-y-1">
                    ...
                    <a href="{{ route('admin.kandang.index') }}"
                        onclick="closeSidebarOnMobile()"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('admin/kandang*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                        </svg>
                    ...
                    <a href="{{ route('admin.pakan.index') }}"
                        onclick="closeSidebarOnMobile()"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('admin/pakan*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- KANDANG DROPDOWN -->
            <div x-data="{ open: {{ request()->is('admin/operasi-kandang*') || request()->is('admin/pendapatan-kandang*') ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition"
                    :class="open ? 'bg-orange-50 text-orange-600' : ''">
                    <div class="flex items-center gap-3">
                ...
                <div x-show="open" x-transition class="ml-6 mt-1 flex flex-col space-y-1">
                    <a href="{{ route('admin.operasi-kandang.index') }}"
                        onclick="closeSidebarOnMobile()"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('admin/operasi-kandang*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                        </svg>
                        <span class="text-sm">Operasi Kandang</span>
                    </a>

                    <a href="{{ route('admin.pendapatan-kandang.index') }}"
                        onclick="closeSidebarOnMobile()"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('admin/pendapatan-kandang*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span class="text-sm">Pendapatan Kandang</span>
                    </a>
                </div>
            </div>

            <!-- PAKAN DROPDOWN -->
            <div x-data="{ open: {{ request()->is('admin/pembelian-pakan*') || request()->is('admin/penggunaan-pakan*') ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="w-full flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition"
                    :class="open ? 'bg-orange-50 text-orange-600' : ''">
                    <div class="flex items-center gap-3">
                ...
                <div x-show="open" x-transition class="ml-6 mt-1 flex flex-col space-y-1">
                    <a href="{{ route('admin.pembelian-pakan.index') }}"
                        onclick="closeSidebarOnMobile()"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('admin/pembelian-pakan*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                        </svg>
                        <span class="text-sm">Pembelian Pakan</span>
                    </a>

                    <a href="{{ route('admin.penggunaan-pakan.index') }}"
                        onclick="closeSidebarOnMobile()"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('admin/penggunaan-pakan*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                        <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>
                        </svg>
                        <span class="text-sm">Penggunaan Pakan</span>
                    </a>
                </div>
            </div>
