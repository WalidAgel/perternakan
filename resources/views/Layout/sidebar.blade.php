...
<body class="min-h-screen bg-[#C9B5A0]">
    ...
    <aside id="sidebar"
        ...
        <!-- MENU -->
        <nav class="flex flex-col space-y-2 text-gray-900 font-medium text-sm pt-6">
            ...
            <div x-data="{ open: {{ request()->is('karyawan*') || request()->is('kategori*') ? 'true' : 'false' }} }">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-200"
                    ...
                    <a href="{{ route('admin.karyawan.index') }}"
                        class="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('karyawan*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                    ...
                    <a href="{{ route('admin.kategori.index') }}"
                        class="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-orange-50 hover:text-orange-600 transition {{ request()->is('kategori*') ? 'bg-orange-100 text-orange-600 font-semibold' : '' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
