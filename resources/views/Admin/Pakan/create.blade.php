...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Tambah Pakan</h1>
    </div>

    <div class="bg-white shadow rounded-xl p-6">
        <form action="{{ route('admin.pakan.store') }}" method="POST">
            @csrf

            <div class="mb-4">
                <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Pakan</label>
                <input type="text" name="nama_pakan" value="{{ old('nama_pakan') }}"
            ...
            <div class="mb-4">
                ...
                <input type="number" name="harga_pakan" value="{{ old('harga_pakan') }}" step="0.01" min="0"
            ...
            <div class="mb-4">
                <label class="block text-sm font-semibold text-gray-700 mb-2">Stok Awal (Kg)</label>
                <input type="number" name="stok" value="{{ old('stok', 0) }}" step="0.01" min="0"
