...
@section('content')
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-white">
                        Edit Operasi Kandang
                    </h1>
                    <p class="text-orange-100 mt-1 text-sm">
                        Perbarui informasi operasi kandang yang sudah ada
                    </p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            ...
            <form action="{{ route('admin.operasi-kandang.update', $operasiKandang->id) }}" method="POST" class="space-y-6">
                    ...
                    <div class="relative">
                        ...
                        <select name="kandang_id" id="kandang_id" required
                            ...
                            @foreach ($kandangs as $kandang)
                                <option value="{{ $kandang->id }}" {{ old('kandang_id', $operasiKandang->kandang_id) == $kandang->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="jumlah_ayam" id="jumlah_ayam" required min="1" step="1"
                            placeholder="0"
                            value="{{ old('jumlah_ayam', $operasiKandang->jumlah_ayam) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="tanggal_mulai_produksi" id="tanggal_mulai_produksi" required
                            value="{{ old('tanggal_mulai_produksi', $operasiKandang->tanggal_mulai_produksi->format('Y-m-d')) }}"
                            max="{{ date('Y-m-d') }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <label class="relative cursor-pointer group">
                            <input type="radio" name="status" value="aktif"
                                {{ old('status', $operasiKandang->status) == 'aktif' ? 'checked' : '' }}
                                class="peer sr-only">
                        ...
                        <label class="relative cursor-pointer group">
                            <input type="radio" name="status" value="selesai"
                                {{ old('status', $operasiKandang->status) == 'selesai' ? 'checked' : '' }}
                                class="peer sr-only">
                            <div class="p-5 border-2 rounded-xl transition-all duration-200
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-sm text-yellow-800">
                            ...
                            <p class="text-yellow-700">
                                Mengubah data operasi kandang dapat mempengaruhi laporan dan perhitungan produksi. Pastikan semua perubahan sudah sesuai dengan kondisi aktual di lapangan.
                            </p>
                        </div>
                    </div>
                </div>
