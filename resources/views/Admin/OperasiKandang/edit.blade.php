...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Operasi Kandang</h1>
    </div>

    <div class="bg-white shadow rounded-xl p-6">
        <form action="{{ route('admin.operasi-kandang.update', $operasiKandang->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="number" name="jumlah_ayam" value="{{ old('jumlah_ayam', $operasiKandang->jumlah_ayam) }}" min="1"
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_mulai_produksi" value="{{ old('tanggal_mulai_produksi', $operasiKandang->tanggal_mulai_produksi->format('Y-m-d')) }}"
            ...
            <div class="mb-4">
                ...
                <select name="status"
                    ...
                    <option value="aktif" {{ old('status', $operasiKandang->status) == 'aktif' ? 'selected' : '' }}>Aktif</option>
                    <option value="selesai" {{ old('status', $operasiKandang->status) == 'selesai' ? 'selected' : '' }}>Selesai</option>
                </select>
            </div>
