...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Tambah Penggunaan Pakan</h1>
        <p class="text-gray-600 text-sm mt-1">Catat penggunaan pakan harian per kandang</p>
    </div>
    ...
    <div class="bg-white shadow rounded-xl p-6">
        <form action="{{ route('admin.penggunaan-pakan.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="jumlah" value="{{ old('jumlah') }}" step="0.01" min="0.01"
