...
@section('content')
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div>
                    ...
                    <p class="text-orange-100 mt-1 text-sm">
                        Perbarui data produksi telur yang sudah dicatat
                    </p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            ...
            <form action="{{ route('admin.produksi.update', $data->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <select name="kandang_id" id="kandang_id" required
                                ...
                                @foreach ($kandangs as $k)
                                    <option value="{{ $k->id }}"
                                        {{ old('kandang_id', $data->kandang_id) == $k->id ? 'selected' : '' }}>
                                        {{ $k->nama_kandang }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="relative">
                            ...
                            <select name="karyawans_id" id="karyawans_id" required
                                ...
                                @foreach ($karyawans as $k)
                                    <option value="{{ $k->id }}"
                                        {{ old('karyawans_id', $data->karyawans_id) == $k->id ? 'selected' : '' }}>
                                        {{ $k->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="jumlah_bagus" id="jumlah_bagus" required min="0" step="1"
                                placeholder="0"
                                value="{{ old('jumlah_bagus', $data->jumlah_bagus) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="jumlah_rusak" id="jumlah_rusak" required min="0" step="1"
                                placeholder="0"
                                value="{{ old('jumlah_rusak', $data->jumlah_rusak) }}"
                                class="w-full pl-12 pr-16 py-3 border border-gray-300 rounded-xl
                                   focus:ring-2 focus:ring-orange-500 focus:border-orange-500
                ...
                <div>
                    ...
                    <textarea name="catatan" id="catatan" rows="4"
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl
                           focus:ring-2 focus:ring-orange-500 focus:border-orange-500
                           @error('catatan') border-red-500 @enderror">{{ old('catatan', $data->catatan) }}</textarea>
                    @error('catatan')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-sm text-yellow-800">
                            ...
                            <p class="text-yellow-700">
                                Mengubah data produksi telur akan mempengaruhi laporan dan analisis performa kandang. Pastikan perubahan sudah sesuai dengan kondisi aktual.
                            </p>
                        </div>
                    </div>
                </div>
