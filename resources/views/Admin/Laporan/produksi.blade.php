...
@section('content')
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="bg-linear-to-br from-blue-500 via-blue-550 to-blue-700 p-6 rounded-xl text-white shadow-lg">
                    ...
                    <tbody class="text-gray-800 divide-y divide-gray-200">
                        @forelse($produksi as $index => $p)
                            <tr class="hover:bg-gray-50 transition duration-150">
                                ...
                                <td class="p-4">
                                    <span
                                        class="text-sm font-medium">{{ \Carbon\Carbon::parse($p->tanggal)->format('d/m/Y') }}</span>
                                </td>
                                <td class="p-4">
                                    <div class="flex items-center">
                                        <div
                                            class="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-white font-bold mr-3">
