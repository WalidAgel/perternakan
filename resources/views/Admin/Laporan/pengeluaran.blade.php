...
<div class="bg-white shadow-md rounded-xl p-6 mb-6">
    <form method="GET" action="{{ route('admin.laporan.pengeluaran') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('admin.laporan.pengeluaran') }}" class="px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded-lg">
                Reset
            </a>
        </div>
    </form>
        ...
        <table class="min-w-full text-left text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 font-semibold text-red-600">Rp {{ number_format($item->jumlah, 0, ',', '.') }}</td>
